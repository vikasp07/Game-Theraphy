...
(In this version, all YouTube-related elements have been removed.)

Extra features in this version:
- Trucks appear on the other track
- The extruded geometry has a texture
- Trees are added around the track
- Shadows are enabled
...
// Removed YouTube element references

setTimeout(() => {
  if (ready) instructionsElement.style.opacity = 1;
  buttonsElement.style.opacity = 1;
  // Removed: youtubeLogo.style.opacity = 1;
}, 4000);

// Initialize Three.js
// Set up camera (using OrthographicCamera)
...
renderMap(cameraWidth, cameraHeight * 2); // The map height is higher because we look from an angle
...
// Removed all YouTube references
